...
META_TABLE_SQL = """CREATE TABLE NioIngestMeta (
    ...
    schema_version INTEGER NOT NULL, stream_id TEXT NOT NULL,
    binding_operation_id TEXT NOT NULL, journal_generation TEXT,
    consumer_generation TEXT, consumer_first_sequence INTEGER,
    baseline_rooms_sha256 BLOB, consumer_attached_revision INTEGER,
    revision INTEGER NOT NULL, writer_epoch TEXT NOT NULL,
    lock_device INTEGER NOT NULL, lock_inode INTEGER NOT NULL,
    next_source_epoch INTEGER NOT NULL, next_ready_order INTEGER NOT NULL,
    next_batch_sequence INTEGER NOT NULL, last_acked_sequence INTEGER NOT NULL,
    last_acked_batch_id TEXT, last_acked_sha256 BLOB,
...
SCHEMA_SQL = (
    """CREATE TABLE NioIngestSourceState (
        ...
        source_epoch INTEGER NOT NULL, transport_kind TEXT NOT NULL
            CHECK (transport_kind IN ('classic', 'sliding')),
    ...
    """CREATE TABLE NioIngestRoomLane (
        ...
        release_loss_id TEXT, ready_order INTEGER,
        next_held_ordinal INTEGER NOT NULL, next_recovery_page INTEGER NOT NULL,
    ...
    """CREATE TABLE NioIngestReadyRecord (
        ...
        source_frame_id TEXT, room_id TEXT,
        membership_epoch INTEGER, room_sequence INTEGER,
    ...
    """CREATE TABLE NioIngestFrame (
        account_id TEXT NOT NULL REFERENCES NioIngestMeta(account_id),
        frame_id TEXT NOT NULL, source_epoch INTEGER NOT NULL,
    ...
    """CREATE TABLE NioIngestCryptoReceipt (
        account_id TEXT NOT NULL REFERENCES NioIngestMeta(account_id),
        input_id TEXT NOT NULL, input_sha256 BLOB NOT NULL,
        result_ciphertext BLOB NOT NULL, result_sha256 BLOB NOT NULL,
