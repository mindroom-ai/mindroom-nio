...
SCHEMA_SQL = (
    ...
    CREATE TABLE NioIngestRoomState (
        ...
        hydration_status TEXT NOT NULL CHECK (
            hydration_status IN ('pending', 'ready', 'unavailable')
        ),
    ...
    CREATE TABLE NioIngestRoomLane (
        ...
        release_phase TEXT NOT NULL CHECK (
            release_phase IN (
    ...
    CREATE TABLE NioIngestLaneRecord (
        ...
        created_revision INTEGER NOT NULL,
        PRIMARY KEY (
            account_id, room_id, membership_epoch,
    ...
    CREATE TABLE NioIngestCryptoReceipt (
        ...
        retention TEXT NOT NULL CHECK (
            retention IN ('until_frame_consumed', 'permanent_olm')
        ),
    ...
    """,
    """
    CREATE INDEX NioIngestPendingDecryption_room_session
    ON NioIngestPendingDecryption(account_id, room_id, sender_key, session_id)
    """,
    """
